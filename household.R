...
## for creating second plot or time series specyfing type and give y label 
plot (datewithtime, Global_active_power, type = "l" , ylab = "Global Active Power (kilowatts)")
